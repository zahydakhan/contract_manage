...
from .serializers import VendorBasicSerializer,VendorTagSerializer,VendorTradeSerializer, VendorBasicReadSerializer
...
class VendorListView(generics.ListAPIView):
    serializer_class=VendorBasicReadSerializer
    queryset=VendorBasic.objects.all()
    filter_backends = (DjangoFilterBackend, OrderingFilter, SearchFilter)
    filter_class = VendorFilter
    search_fields=('active','tags__vendortagname','trade__vendortrade', 'supp_name', )
