        ...
        <React.Fragment>
            <Grid container sm={6} xs={12} justify='space-between'>
                <Grid container item>
                  ...
                  <TextField id="standard-search" label="Search Department" type="search" className={classes.search} onChange={handleChange} />
                  </Grid>
                </Grid>
                <Grid item>
                    <ConfigDeptTable searchResult={searchResult} />
                </Grid>
            </Grid>
        </React.Fragment>
    );
