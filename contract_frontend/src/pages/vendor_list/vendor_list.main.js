    ...
    <form className={classes.root} noValidate autoComplete="off">
      <Grid container >
        <Grid container>
          ...
          <Grid item>
          <Typography variant='h2' >Search Vendor</Typography>
          </Grid>
        </Grid>
      ...
      <Grid item>
        <Grid container direction='column'>
          ...
          <Grid item>
        <TextField id="standard-search" label="Search by Supplier Name, Tags or Trade" type="search" className={classes.search} onChange={handleChange} />
        </Grid>
        </Grid>
        </Grid>
